...
export default function ProtectedRoutes({ children }) {
  ...
  const roleRoutes = {
    ...
    "Seo Manager": [
      ...
      "/dashboard/give-feedback",
      "/dashboard/feedback",
      "/dashboard/feedback/view/:objectId",
      "/dashboard/support",
      "/dashboard/support/new",
      "/dashboard/support/:objectId",
    ],
    Editor: [
      ...
      "/dashboard/course/edit/:objectId",
      "/dashboard/retreat",
      "/dashboard/retreat/create",
      "/dashboard/retreat/view/:objectId",
      "/dashboard/retreat/edit/:objectId",
      "/dashboard/category",
      "/dashboard/category/create",
      "/dashboard/category/view/:objectId",
      "/dashboard/category/edit/:objectId",
