...
import CreatePackages from "./pages/Retreats/CreateRetreat";
import RetreatList from "./pages/Retreats/RetreatList";
import SoftDeletedRetreat from "./pages/Retreats/DeletedRetreat";
import EditRetreat from "./pages/Retreats/EditRetreat";
import ViewRetreat from "./pages/Retreats/ViewRetreat";
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/dashboard/analytics/:objectId" element={<Analytics/>}/>
              ...
              <Route path="/dashboard/retreat"element={<ProtectedRoutes><RetreatList /></ProtectedRoutes>}/>
              <Route path="/dashboard/retreat/create"element={<ProtectedRoutes><CreatePackages /></ProtectedRoutes>}/>
              <Route path="/dashboard/retreat/view/:objectId"element={<ProtectedRoutes><ViewRetreat /></ProtectedRoutes>}/>
              <Route path="/dashboard/retreat/edit/:objectId"element={<ProtectedRoutes><EditRetreat /></ProtectedRoutes>}/>
              <Route path="/dashboard/retreat/soft"element={<ProtectedRoutes><SoftDeletedRetreat /></ProtectedRoutes>}/>
              ...
              <Route path="/dashboard/give-feedback" element={<ProtectedRoutes><GiveFeedback/></ProtectedRoutes>}/>
              <Route path="/dashboard/feedback" element={<ProtectedRoutes><Feedback/></ProtectedRoutes>}/>
              <Route path="/dashboard/feedback/view/:objectId" element={<ProtectedRoutes><ViewFeedback/></ProtectedRoutes>}/>

              <Route path="/dashboard/support" element={<ProtectedRoutes><Support/></ProtectedRoutes>} />
              <Route path="/dashboard/support/new" element={<ProtectedRoutes><NewSupportQuery/></ProtectedRoutes>} />
              <Route path="/dashboard/support/:objectId" element={<ProtectedRoutes><SupportChat/></ProtectedRoutes>} />
            </Route>
          </Routes>
        </BrowserRouter>
      </HelmetProvider>
