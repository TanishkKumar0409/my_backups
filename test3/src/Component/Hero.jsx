...
export default function Hero(props) {
  return (
    <>
      <section className={`hero vh-100 d-flex align-items-center justify-content-center text-center position-relative bg-${props.darkTheme} text-${props.darkTheme==="dark"?"light":"dark"}`}>
