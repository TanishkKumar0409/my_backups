      ...
      try {
        ...
        reader.onload = () => {
          if (fileExtension === 'docx') {
            ...
            const googleSlidesUrl = `https://docs.google.com/presentation/d/${data.filePath.split('/').pop()}/embed`;
            setHtmlContent(`<iframe src="${googleSlidesUrl}" width="100%" height="600px" frameborder="0"></iframe>`);
          } else {
